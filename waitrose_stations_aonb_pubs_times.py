...
for station_name, station_lat, station_lon in station_data:
    time_from_london = estimate_travel_time(london_lat, london_lon, station_lat, station_lon)
    time_from_abergavenny = estimate_travel_time(abergavenny_lat, abergavenny_lon, station_lat, station_lon)
